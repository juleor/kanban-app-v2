...
func (a *modifyWeb) AddTask(w http.ResponseWriter, r *http.Request) {
	...
	catInt, _ := strconv.Atoi(catId)
	data := map[string]interface{}{
		"catid": catInt,
	}

	tmpl, err := template.ParseFS(a.embed, "views/main/add-task.html", "views/general/header.html")
	if err != nil {
		panic(err)
	}
...
func (a *modifyWeb) AddCategory(w http.ResponseWriter, r *http.Request) {
	tmpl, err := template.ParseFS(a.embed, "views/main/add-category.html", "views/general/header.html")
	if err != nil {
		panic(err)
	}
...
func (a *modifyWeb) UpdateTask(w http.ResponseWriter, r *http.Request) {
	...
	tmpl, err := template.ParseFS(a.embed, "views/main/update-task.html", "views/general/header.html")
	if err != nil {
		panic(err)
	}
