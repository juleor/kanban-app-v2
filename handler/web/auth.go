...
func (a *authWeb) Login(w http.ResponseWriter, r *http.Request) {
	tmpl, err := template.ParseFS(a.embed, "views/auth/login.html", "views/general/header.html")
	if err != nil {
		panic(err)
	}
...
func (a *authWeb) Register(w http.ResponseWriter, r *http.Request) {
	tmpl, err := template.ParseFS(a.embed, "views/auth/register.html", "views/general/header.html")
	if err != nil {
		panic(err)
	}
